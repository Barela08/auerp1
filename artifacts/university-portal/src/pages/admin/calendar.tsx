  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1">Upload calendar image/PDF and manage academic events</p>
      </div>
      ...
      <Card className="shadow-sm">
        <CardHeader className="border-b pb-3">
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            Upload a calendar image or PDF. Students will see it at the top of their Calendar page.
          </p>
        </CardHeader>
